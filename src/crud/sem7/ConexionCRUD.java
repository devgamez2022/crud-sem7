...
public class ConexionCRUD {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        /*Bloque 1. Prueba de funcionamiento del método guardar
        String tabla = "tb_contacto";
        String camposTabla = "nom_contacto, email_contacto, tel_contacto";
        String valoresCampos = "'Juan Gamez','juang@itca.edu.sv','6755-0100'";
        objeto.guardarRegistros(tabla, camposTabla, valoresCampos);*/

        /*Bloque 2. Prueba de funcionamiento del método eliminar
        String tabla = "tb_contacto";
        String condicion = "id_contacto = 4";
        String valoresCamposNuevos = "";
        objeto.actualizarEliminarRegistro(tabla, valoresCamposNuevos, condicion);*/
        
        
        /*Bloque 3. Prueba de funcionamiento del método actualizar
        String tabla = "tb_contacto";
        String condicion = "id_contacto = 3";
        String valoresCamposNuevos = "nom_contacto='prueba',email_contacto='prueba@itca.edu.sv',tel_contacto='1111-1111'";
        objeto.actualizarEliminarRegistro(tabla, valoresCamposNuevos, condicion);*/
        
        /*Bloque 4. Prueba de funcionamiento del métedo consultar 1
        ...
        //Bloque 5. Prueba de funcionamiento del métedo consultar 2*/
        String tablaBuscar = "tb_contacto";
        String camposBuscar = "nom_contacto, email_contacto, tel_contacto";
        String condicionBuscar = "id_contacto = 3";
        objeto.desplegarRegistros(tablaBuscar, camposBuscar, condicionBuscar);
        ...
        /*Bloque 2. Prueba de funcionamiento del método actualizar*/
    ...
    public void actualizarEliminarRegistro(String tabla, String valoresCamposNuevos, String condicion) {
        ...
        try {
            ...
            if (valoresCamposNuevos.isEmpty()) {
                ...
                //              DELETE FROM `tb_contacto` WHERE `id_contacto`= 1
